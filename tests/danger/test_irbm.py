...
IRBM_CASES: list[tuple[str, str]] = [
    ...
    (IRBM_DANGER[1], "пуск Орєшніка"),
    (
        IRBM_DANGER[2],
        "🚀 Є інформація про пуск Орешніка! Протягом 10 хвилин уважно.",
    ),
    (IRBM_DANGER[3], "🚀 Була інформація про пуск Орєшніка!"),
    (IRBM_DANGER[4], "❗️Загроза пусків Орєшніка!"),
    (IRBM_DANGER[4], "🔴❗️Загроза застосування «Орєшніка»!"),
    (IRBM_DANGER[4], "❗️Загроза нанесення Орешніка!"),
    (IRBM_DANGER[4], "Upd. Загроза пуски Орєшніка!"),
    (IRBM_DANGER[4], "загроза орєшніка"),
    (IRBM_DANGER[5], "тривога по Орєшніку!"),
    (IRBM_DANGER[6], "🔴По Орєшніку загроза актуальна!"),
    (
        IRBM_DANGER[7],
