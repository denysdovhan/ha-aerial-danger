...
CRUISE_CASES: list[str] = [
    ...
    '❗️ Ще одна "Бандероль" у бік Одещини. Затока/Маяки.',
    "🟡🚀 3х Бандероль над акваторією Чорного моря, вектор Нові Білярі!",
    "🚀Бандеролі через Чернігівщину в напрямку Києва.",
    "🚀КР на Київ!",
