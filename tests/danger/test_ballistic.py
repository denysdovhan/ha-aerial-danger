...
BALLISTIC_NO_MATCH_CASES: list[str] = [
    (
        "🤓Завдяки деяким успішним діям Сил оборони України, пускові установки "
        "ОТРК Іскандер, які дислокуються в Брянській області рф та "
        "застосовуються для здійснення ракетних ударів по Києву, протягом "
        "найближчих трьох діб не зможуть здійснити пересування на"
    ),
    (
    ...
    "СБУ встановила, що Циркон з Курська на Київ запустили 8 серпня.",
    "У новинах: Циркон північніше Броварів учора збили.",
    "Новини: Перша група Цирконів на Бориспіль/Українку була знищена.",
]
