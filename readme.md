...
It detects intermediate-range ballistic missiles (IRBMs), ballistic missiles, cruise missiles, drones, and unclassified aerial threats.
...
**Місцевості** потрібні для виявлення дронів і також використовуються для всіх інших типів загроз.
...
| -------------------- | -------------------------------------------------------------------- | ------------------------------------------------- |
| Сенсори небезпеки    | БРСД[^1], балістика, крилаті ракети, дрони, невстановлена небезпека  | Показують активну загрозу відповідного типу       |
